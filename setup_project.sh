...
find . -type f -not -path '*/\.*' -not -path '*/venv/*' -not -name 'setup_project.sh' -exec sed -i.bak "s/crewai_template/$PROJECT_NAME/g" {} +
find . -type f -not -path '*/\.*' -not -path '*/venv/*' -not -name 'setup_project.sh' -exec sed -i.bak "s/CrewaiTemplate/$PROJECT_NAME_PASCAL/g" {} +
find . -type f -not -path '*/\.*' -not -path '*/venv/*' -not -name 'setup_project.sh' -exec sed -i.bak "s/Crewai Template/$PROJECT_NAME_PASCAL/g" {} +
find . -type f -not -path '*/\.*' -not -path '*/venv/*' -not -name 'setup_project.sh' -exec sed -i.bak "s/CrewAI Template/$PROJECT_NAME_PASCAL/g" {} +
...
sed -i.bak "s/CrewAI Template/$PROJECT_NAME_PASCAL/" pyproject.toml
